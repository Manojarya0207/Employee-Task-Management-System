        ...
        with ui.element('div').classes('w-full min-h-screen flex items-center justify-center p-4'):
            ...
            with ui.element('div').classes('glass-card p-8 w-full max-w-md'):
                ...
                with form_container:
                    ...
                    password_input = ui.input(label='Password', password=True, password_toggle_button=True).classes('w-full mb-6').props('outlined color=primary').on('keydown.enter', lambda: try_login())
                ...
                with status_container:
                    ...
                    def check_status(target_id=None):
                        id_to_check = target_id or status_id_input.value
                        if not id_to_check:
                    ...
                    ui.button('Check Status', on_click=lambda: check_status()).classes('w-full py-2 mb-3 btn-neon').props('unelevated')
